      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          ...
          floatingActionButton: FloatingActionButton.extended(
            onPressed: () async {
              logFirebaseEvent('PROFILE_FloatingActionButton_2dh0gx58_ON');
              logFirebaseEvent('FloatingActionButton_navigate_to');

              context.pushNamed('myTweets');
            },
            ...
            children: [
                                              ...
                                              children: [
                                                Align(
                                                  ...
                                                  child: FFButtonWidget(
                                                    onPressed: () async {
                                                      logFirebaseEvent(
                                                          'PROFILE_PAGE_PAGE_FOLLOWERS_BTN_ON_TAP');
                                                      logFirebaseEvent(
                                                          'Button_navigate_to');
                                                ...
                                                FFButtonWidget(
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'PROFILE_PAGE_PAGE_FOLLOWING_BTN_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Button_navigate_to');
                                                ...
                                                FFButtonWidget(
                                                  onPressed: () async {
                                                    logFirebaseEvent(
                                                        'PROFILE_PAGE_PAGE_USERS_BTN_ON_TAP');
                                                    logFirebaseEvent(
                                                        'Button_navigate_to');
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent(
                        'PROFILE_YOUR_PERSONALIZED_PLAN_BTN_ON_TA');
