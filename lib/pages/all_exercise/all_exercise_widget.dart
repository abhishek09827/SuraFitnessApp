...
import 'all_exercise_model.dart';
export 'all_exercise_model.dart';

class AllExerciseWidget extends StatefulWidget {
  const AllExerciseWidget({
    Key? key,
    this.rourineId,
    this.srwRef,
  }) : super(key: key);
  ...
  @override
  _AllExerciseWidgetState createState() => _AllExerciseWidgetState();
}

class _AllExerciseWidgetState extends State<AllExerciseWidget>
    with TickerProviderStateMixin {
  late AllExerciseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AllExerciseModel());

    logFirebaseEvent('screen_view', parameters: {'screen_name': 'allExercise'});
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton.extended(
          onPressed: () async {
            logFirebaseEvent('ALL_EXERCISE_FloatingActionButton_5hldc9');
          ...
          desktop: false,
            ...
            ? AppBar(
                ...
                leading: FlutterFlowIconButton(
                  ...
                  onPressed: () async {
                    logFirebaseEvent(
                        'ALL_EXERCISE_arrow_back_rounded_ICN_ON_T');
                                                  ...
                                                  children: [
                                                    if (columnWorkoutsRecord
                                                      ...
                                                      FlutterFlowIconButton(
                                                        ...
                                                        onPressed: () async {
                                                          logFirebaseEvent(
                                                              'ALL_EXERCISE_PAGE_add_ICN_ON_TAP');
                                                          logFirebaseEvent(
                                                              'IconButton_backend_call');

                                                          await columnWorkoutsRecord
                                                              .reference
                                                              .update({
                                                            'exercisesDone':
                                                                FieldValue
                                                          ...
                                                          var exercisesInRoutineRecordReference =
                                                              ExercisesInRoutineRecord
                                                                  .createDoc(widget
                                                                      .rourineId!);
                                                          await exercisesInRoutineRecordReference
                                                              .set(
                                                          ...
                                                          _model.eIR = ExercisesInRoutineRecord
                                                              .getDocumentFromData(
                                                                  createExercisesInRoutineRecordData(
                                                                    uid:
                                                                        currentUserReference,
                                                    ...
                                                    if (columnWorkoutsRecord
                                                      ...
                                                      FlutterFlowIconButton(
                                                        ...
                                                        onPressed: () async {
                                                          logFirebaseEvent(
                                                              'ALL_EXERCISE_PAGE_minus_ICN_ON_TAP');
                                                          logFirebaseEvent(
                                                              'IconButton_backend_call');
                                                    ...
                                                    if (columnWorkoutsRecord
                                                      ...
                                                      FlutterFlowIconButton(
                                                        ...
                                                        onPressed: () async {
                                                          ...
                                                          _model.eI = ExercisesInRoutineRecord
                                                              .getDocumentFromData(
                                                                  createExercisesInRoutineRecordData(
                                                                    uid:
                                                                        currentUserReference,
