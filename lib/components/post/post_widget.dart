          ...
          child: Column(
            ...
            children: [
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        logFirebaseEvent('POST_COMP_Icon_3lky8rxp_ON_TAP');
              ...
              Container(
                ...
                decoration: BoxDecoration(),
                child: Visibility(
                  visible: _model.isDataUploading1 == true,
                  child: Container(
                    ...
                    child: Visibility(
                      visible: _model.isDataUploading1 == false,
                      child: Hero(
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('POST_COMP_UPLOAD_IMAGE_BTN_ON_TAP');
              ...
              Align(
                ...
                child: Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('POST_COMP_UPLOAD_VIDEO_BTN_ON_TAP');
                      logFirebaseEvent('Button_upload_media_to_firebase');
                      final selectedMedia =
                          await selectMediaWithSourceBottomSheet(
                        context: context,
                            ...
                            children: [
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    logFirebaseEvent(
                                        'POST_COMP_CREATE_POST_BTN_ON_TAP');
                                    logFirebaseEvent('Button_backend_call');

                                    await TweetsRecord.createDoc(
                                            currentUserReference!)
                                        .set(createTweetsRecordData(
                                      name: _model.inputMessageController.text,
