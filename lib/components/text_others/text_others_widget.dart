...
import 'text_others_model.dart';
export 'text_others_model.dart';

class TextOthersWidget extends StatefulWidget {
  const TextOthersWidget({
    Key? key,
    this.others,
  }) : super(key: key);
  ...
  @override
  _TextOthersWidgetState createState() => _TextOthersWidgetState();
}

class _TextOthersWidgetState extends State<TextOthersWidget> {
  late TextOthersModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TextOthersModel());
              ...
              children: [
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('TEXT_OTHERS_COMP__BTN_ON_TAP');
                      logFirebaseEvent('Button_backend_call');

                      var wOthersRecordReference =
                          WOthersRecord.collection.doc();
                      await wOthersRecordReference.set(createWOthersRecordData(
                      ...
                      _model.chetsWork = WOthersRecord.getDocumentFromData(
                          createWOthersRecordData(
                            uid: currentUserReference,
                            set: int.tryParse(_model.setController.text),
                            reps: int.tryParse(_model.repController.text),
                            kg: int.tryParse(_model.kgsController.text),
