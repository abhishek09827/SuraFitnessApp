...
import 'text_legs_model.dart';
export 'text_legs_model.dart';

class TextLegsWidget extends StatefulWidget {
  const TextLegsWidget({
    Key? key,
    this.legs,
  }) : super(key: key);

  final DocumentReference? legs;

  @override
  _TextLegsWidgetState createState() => _TextLegsWidgetState();
}

class _TextLegsWidgetState extends State<TextLegsWidget> {
  late TextLegsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TextLegsModel());
              ...
              children: [
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      logFirebaseEvent('TEXT_LEGS_COMP__BTN_ON_TAP');
                      logFirebaseEvent('Button_backend_call');

                      var wLegsRecordReference = WLegsRecord.collection.doc();
                      await wLegsRecordReference.set(createWLegsRecordData(
                      ...
                      _model.chetsWork = WLegsRecord.getDocumentFromData(
                          createWLegsRecordData(
                            uid: currentUserReference,
                            set: int.tryParse(_model.setController.text),
                            reps: int.tryParse(_model.repController.text),
                            kg: int.tryParse(_model.kgsController.text),
